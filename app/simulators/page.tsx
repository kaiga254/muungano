			...
			<Card className="border-border/70 bg-card/95 shadow-sm">
				...
				<CardContent>
					<p className="max-w-3xl text-sm text-muted-foreground">
						Each simulator now has its own interface and employee sub-accounts. Payroll
						distribution writes transactions directly to Neon, so balances and histories
						update immediately after settlement.
					</p>
				</CardContent>
			</Card>
