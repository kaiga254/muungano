          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-2xl text-base text-muted-foreground md:text-lg">
                Hold KES, MWK, and USD. Deposit via bank or mobile money, send
                cross-border ILP payments, and withdraw — all from one
          ...
          <div className="grid gap-4 rounded-xl border border-border/70 bg-muted/40 p-6">
            ...
            <div className="grid gap-3 text-sm text-muted-foreground">
              <div className="rounded-lg border border-border/70 bg-background/80 p-4">
                Sign up with your phone number and complete Tier-1 KYC to unlock
